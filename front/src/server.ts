 ...
 * Referrer-Policy, HSTS, etc). The CSP is intentionally permissive on style/font sources
 * to allow Google Fonts (see index.html) — tighten further if those are removed.
 */
app.use(
  helmet({
    ...
    // Only takes effect over HTTPS; harmless over plain HTTP in local dev.
