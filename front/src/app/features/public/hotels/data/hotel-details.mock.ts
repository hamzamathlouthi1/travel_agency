...
const MERIDIAN_ROOMS: readonly HotelRoom[] = [
  {
    ...
    images: [{ id: 'deluxe-1', alt: 'Deluxe Bosphorus Room with king bed and Bosphorus view' }],
    ratePlans: [
      {
  ...
  },
  {
    ...
    images: [{ id: 'standard-1', alt: 'Standard Room with two twin beds and city view' }],
    ratePlans: [
      {
  ...
  },
  {
    ...
    view: 'Courtyard view',
    amenities: [AMENITIES['wifi'], AMENITIES['ac']],
    images: [{ id: 'classic-1', alt: 'Classic City Room with double bed' }],
    ratePlans: [
      {
        id: 'demo-sold-out',
        boardType: 'ROOM_ONLY',
  ...
  },
  {
    ...
    images: [{ id: 'suite-1', alt: 'Family Suite with separate lounge area' }],
    ratePlans: [
      {
        id: 'suite-halfboard',
...
const MERIDIAN_DETAIL: HotelDetail = {
  ...
  images: [
    { id: 'meridian-1', alt: 'Meridian Bosphorus Hotel exterior at dusk' },
    { id: 'meridian-2', alt: 'Lobby lounge with Bosphorus-facing windows' },
    { id: 'meridian-3', alt: 'Rooftop terrace overlooking the Bosphorus' },
    { id: 'meridian-4', alt: 'Deluxe Bosphorus Room interior' },
    { id: 'meridian-5', alt: 'Hotel spa treatment room' },
  ],
  amenities: [
    AMENITIES['wifi'],
    AMENITIES['pool'],
...
function generatedDetail(fixtureId: string): HotelDetail | null {
  ...
  const room: HotelRoom = {
    ...
    images: [{ id: `${fixture.id}-room-1`, alt: `${fixture.roomName} at ${fixture.name}` }],
  ...
  return {
    ...
    images: [{ id: `${fixture.id}-hero`, alt: `${fixture.name} exterior` }],
    amenities: fixture.amenities,
    location: {
      area: fixture.area,
      destination: fixture.destination,
